...
num_calls_b_and_b = 0
num_calls_J = 0
def select_b_and_b(training_data, n_components, svd_solver, fault_data, fault_detection_index=None, fault_num='Undefined', k_select=2, trace=False, quiet=False):
...
def test_multivar_fault_detection():
    ...
    #fault_detection_index = 'T2'
    #fault_detection_index = 'SPE'
    #fault_detection_index = 'Combined' #kkk
    faultdirections = 'Random'
    num_sensores_pub1 = 6
